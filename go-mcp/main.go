// Command BerufsbildungDatenExporte-mcp is an MCP server exposing the BerufsbildungDatenExporte
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BerufsbildungDatenExporte_list  — list records of an entity
//	BerufsbildungDatenExporte_load  — load a single record of an entity
//
