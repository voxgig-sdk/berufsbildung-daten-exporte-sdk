...
type Args struct {
	Entity string         `json:"entity" jsonschema:"berufsbildung"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BerufsbildungDatenExporteSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "berufsbildung-daten-exporte_list",
		Description: "List records from BerufsbildungDatenExporte. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "berufsbildung-daten-exporte_load",
		Description: "Load a single record from BerufsbildungDatenExporte. " +
...
func runOp(client *sdk.BerufsbildungDatenExporteSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BerufsbildungDatenExporteSDK, name string) (sdk.BerufsbildungDatenExporteEntity, error) {
	switch strings.ToLower(name) {
	case "berufsbildung":
		return client.Berufsbildung(nil), nil
