...
from berufsbildungdatenexporte_sdk.utility import register

# Load features
from berufsbildungdatenexporte_sdk.feature.base_feature import BerufsbildungDatenExporteBaseFeature
from berufsbildungdatenexporte_sdk.features import _has_feature, _make_feature
...
class BerufsbildungDatenExporteSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BerufsbildungDatenExporteUtility()
    ...
    def get_utility(self):
        return BerufsbildungDatenExporteUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BerufsbildungDatenExporteSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Berufsbildung(self, data=None) -> "BerufsbildungEntity":
        ...
        from berufsbildungdatenexporte_sdk.entity.berufsbildung_entity import BerufsbildungEntity
