...
from berufsbildungdatenexporte_sdk.core.control import BerufsbildungDatenExporteControl
...
from berufsbildungdatenexporte_sdk.core.helpers import get_ctx_prop, to_map
...
class BerufsbildungDatenExporteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BerufsbildungDatenExporteControl()
        ...
        if isinstance(sp, BerufsbildungDatenExporteSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BerufsbildungDatenExporteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BerufsbildungDatenExporteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BerufsbildungDatenExporteOperation({})
    ...
    def make_error(self, code, msg):
        return BerufsbildungDatenExporteError(code, msg, self)
