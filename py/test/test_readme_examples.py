# BerufsbildungDatenExporte SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BerufsbildungDatenExporteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BerufsbildungDatenExporteSDK(...) and BerufsbildungDatenExporteSDK.test(...) become
#      BerufsbildungDatenExporteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "berufsbildungdatenexporte_sdk"
_SDK_CLASS = "BerufsbildungDatenExporteSDK"
