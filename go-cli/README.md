...
AQL-driven CLI and REPL for the BerufsbildungDatenExporte SDK. Positional arguments are
...
```sh
go build -o berufsbildung-daten-exporte-cli ./...
```
...
./berufsbildung-daten-exporte-cli load 1 berufsbildung
./berufsbildung-daten-exporte-cli load '{id:1}' berufsbildung
