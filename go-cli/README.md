...
AQL-driven command-line client **and** interactive REPL for the BerufsbildungDatenExporte
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `berufsbildung`).
