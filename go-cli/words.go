...
func registerSDKWords(r *eng.Registry, client *sdk.BerufsbildungDatenExporteSDK) {
...
func runOp(client *sdk.BerufsbildungDatenExporteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
