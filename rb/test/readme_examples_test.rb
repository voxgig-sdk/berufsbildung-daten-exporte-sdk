...
#      offline in seeded test mode (BerufsbildungDatenExporteSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BerufsbildungDatenExporte_sdk.rb")
  SDK_CLASS = "BerufsbildungDatenExporteSDK"
  ...
  SDK_BASE = "BerufsbildungDatenExporte_sdk"
