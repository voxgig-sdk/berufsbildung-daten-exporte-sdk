# BerufsbildungDatenExporte SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # BerufsbildungDatenExporteSDK.new, not BerufsbildungDatenExporteSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    BerufsbildungDatenExporteSDK.new(opts)
  end
