...
require_relative 'BerufsbildungDatenExporte_types'
...
class BerufsbildungDatenExporteSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = BerufsbildungDatenExporteHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = BerufsbildungDatenExporteHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, BerufsbildungDatenExporteFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    BerufsbildungDatenExporteUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = BerufsbildungDatenExporteHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = BerufsbildungDatenExporteHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = BerufsbildungDatenExporteHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => BerufsbildungDatenExporteError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue BerufsbildungDatenExporteError => err
    ...
    if fetched.is_a?(Hash)
      status = BerufsbildungDatenExporteHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = BerufsbildungDatenExporteError.new(
        "graphql_error", "BerufsbildungDatenExporteSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = BerufsbildungDatenExporteSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
