...
local BerufsbildungEntity = {}
BerufsbildungEntity.__index = BerufsbildungEntity


function BerufsbildungEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BerufsbildungEntity)
  self._name = "berufsbildung"
  self._client = client
...
function BerufsbildungEntity:get_name()
  return self._name
end


function BerufsbildungEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BerufsbildungEntity.new(self._client, opts)
end
...
function BerufsbildungEntity:mark_deleted()
  self._deleted = true
end


function BerufsbildungEntity:deleted()
  return true == self._deleted
end


function BerufsbildungEntity:data_set(args)
  if args ~= nil then
...
function BerufsbildungEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BerufsbildungEntity:match_set(args)
  if args ~= nil then
...
function BerufsbildungEntity:match_get()
...
function BerufsbildungEntity:stream(action, args, callopts)
...
function BerufsbildungEntity:_run_op(ctx, post_done)
  local utility = self._utility
