...
const BerufsbildungDatenExporteError_1 = require("./BerufsbildungDatenExporteError");
...
class Context {
    ...
    error(code, msg) {
        return new BerufsbildungDatenExporteError_1.BerufsbildungDatenExporteError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
