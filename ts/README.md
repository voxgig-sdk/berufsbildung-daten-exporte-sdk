# BerufsbildungDatenExporte TypeScript SDK



The TypeScript SDK for the BerufsbildungDatenExporte API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Berufsbildung()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `BerufsbildungDatenExporteSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `BerufsbildungDatenExporteSDK.test(testopts?, sdkopts?)` | `BerufsbildungDatenExporteSDK` | Create a test-mode client. |
...
├── src/
│   ├── BerufsbildungDatenExporteSDK.ts        # Main SDK class
