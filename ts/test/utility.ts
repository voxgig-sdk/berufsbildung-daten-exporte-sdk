...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BERUFSBILDUNGDATENEXPORTE_TEST_LIVE ||
    'TRUE' === process.env.BERUFSBILDUNGDATENEXPORTE_TEST_OVERRIDE
  ) {
  ...
  m.BERUFSBILDUNGDATENEXPORTE_TEST_EXPLAIN = process.env.BERUFSBILDUNGDATENEXPORTE_TEST_EXPLAIN || m.BERUFSBILDUNGDATENEXPORTE_TEST_EXPLAIN
