...
function envOverride(m) {
    if ('TRUE' === process.env.BERUFSBILDUNG_DATEN_EXPORTE_TEST_LIVE ||
        'TRUE' === process.env.BERUFSBILDUNG_DATEN_EXPORTE_TEST_OVERRIDE) {
    ...
    m.BERUFSBILDUNG_DATEN_EXPORTE_TEST_EXPLAIN = process.env.BERUFSBILDUNG_DATEN_EXPORTE_TEST_EXPLAIN || m.BERUFSBILDUNG_DATEN_EXPORTE_TEST_EXPLAIN;
    return m;
}
