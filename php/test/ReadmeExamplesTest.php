...
// BerufsbildungDatenExporte SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BerufsbildungDatenExporteSDK::test)
...
{
    private const SDK_CLASS = 'BerufsbildungDatenExporteSDK';
    ...
    private const SDK_BASE = 'berufsbildungdatenexporte_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../berufsbildungdatenexporte_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
