...
// BerufsbildungDatenExporte SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BerufsbildungDatenExporteOmni::makeStructRunner(
    ...
    {
        return BerufsbildungDatenExporteOmni::objmodel(BerufsbildungDatenExporteOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BerufsbildungDatenExporteOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BerufsbildungDatenExporteOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BerufsbildungDatenExporteOmni::structfix($now, Struct::undef()))
                        !== json_encode(BerufsbildungDatenExporteOmni::structfix($val, Struct::undef()))) {
