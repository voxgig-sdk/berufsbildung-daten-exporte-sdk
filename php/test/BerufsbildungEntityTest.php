...
class BerufsbildungEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BERUFSBILDUNGDATENEXPORTE_TEST_BERUFSBILDUNG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function berufsbildung_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BERUFSBILDUNGDATENEXPORTE_TEST_BERUFSBILDUNG_ENTID");
