...
// BerufsbildungDatenExporte SDK pipeline test
//
...
{
    private static function utility(): BerufsbildungDatenExporteUtility
    {
        return new BerufsbildungDatenExporteUtility();
    }
    ...
    private static function ctx(array $over = []): BerufsbildungDatenExporteContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BerufsbildungDatenExporteContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BerufsbildungDatenExporteError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BerufsbildungDatenExporteMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BerufsbildungDatenExporteMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BerufsbildungDatenExporteMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BerufsbildungDatenExporteSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BerufsbildungDatenExporteMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BerufsbildungDatenExporteResponse([]),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        [, $err] = BerufsbildungDatenExporteMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec([]),
            'response' => null,
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        [, $err] = BerufsbildungDatenExporteMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's']),
            'response' => new BerufsbildungDatenExporteResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        [, $err] = BerufsbildungDatenExporteMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's']),
            'response' => new BerufsbildungDatenExporteResponse(self::resp(200, ['v' => 1])),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        [, $err] = BerufsbildungDatenExporteMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's']),
            'response' => new BerufsbildungDatenExporteResponse(self::resp(200, ['v' => 2])),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BerufsbildungDatenExporteMakeResponse::call($ctx);
    ...
    {
        $preset = new BerufsbildungDatenExporteResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec([]),
            'response' => new BerufsbildungDatenExporteResponse([]),
            'result' => new BerufsbildungDatenExporteResult([]),
        ...
        [$got, $err] = BerufsbildungDatenExporteMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BerufsbildungDatenExporteResult([])]);
        [, $err] = BerufsbildungDatenExporteMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BerufsbildungDatenExporteSpec([]), 'result' => null]);
        [, $err] = BerufsbildungDatenExporteMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's']),
            'result' => new BerufsbildungDatenExporteResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BerufsbildungDatenExporteMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's']),
            'result' => new BerufsbildungDatenExporteResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BerufsbildungDatenExporteOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BerufsbildungDatenExporteMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BerufsbildungDatenExporteResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BerufsbildungDatenExporteSpec([]),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BerufsbildungDatenExporteMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BerufsbildungDatenExporteMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BerufsbildungDatenExporteError('boom', 'boom');
        $utility->fetcher = function (BerufsbildungDatenExporteContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BerufsbildungDatenExporteMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BerufsbildungDatenExporteContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BerufsbildungDatenExporteMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BerufsbildungDatenExporteResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BerufsbildungDatenExporteMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BerufsbildungDatenExporteContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BerufsbildungDatenExporteSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BerufsbildungDatenExporteMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BerufsbildungDatenExporteResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BerufsbildungDatenExporteSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BerufsbildungDatenExporteMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BerufsbildungDatenExporteMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BerufsbildungDatenExporteMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BerufsbildungDatenExporteResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BerufsbildungDatenExporteDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BerufsbildungDatenExporteResult(['ok' => false])]);
        $this->expectException(BerufsbildungDatenExporteError::class);
        BerufsbildungDatenExporteDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BerufsbildungDatenExporteResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BerufsbildungDatenExporteMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BerufsbildungDatenExporteMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BerufsbildungDatenExporteBaseFeature();
        $b = new BerufsbildungDatenExporteBaseFeature();
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $a);
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BerufsbildungDatenExporteBaseFeature
    {
        $f = new BerufsbildungDatenExporteBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BerufsbildungDatenExporteFeatureAdd::call($ctx, self::named_feature('a'));
        BerufsbildungDatenExporteFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $replace);
        ...
        BerufsbildungDatenExporteFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BerufsbildungDatenExporteContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BerufsbildungDatenExporteSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BerufsbildungDatenExportePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BerufsbildungDatenExportePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BerufsbildungDatenExporteResponse(['headers' => null]),
            'result' => new BerufsbildungDatenExporteResult([]),
        ]);
        BerufsbildungDatenExporteResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BerufsbildungDatenExporteResultBody::call($ctx);
