...
// BerufsbildungDatenExporte SDK feature test
//
...
class FtCtrl extends BerufsbildungDatenExporteControl
{
...
class FtClient
{
    ...
    private BerufsbildungDatenExporteUtility $utility;

    public function __construct(BerufsbildungDatenExporteUtility $utility, array $options)
    {
    ...
    public function get_utility(): BerufsbildungDatenExporteUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BerufsbildungDatenExporteContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BerufsbildungDatenExporteContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BerufsbildungDatenExporteContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BerufsbildungDatenExporteConfig::make_feature($name);
    ...
    private static function buildUrl(BerufsbildungDatenExporteSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BerufsbildungDatenExporteError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BerufsbildungDatenExporteResponse($fetched);
        }
    ...
    private function fail(BerufsbildungDatenExporteContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BerufsbildungDatenExporteContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
