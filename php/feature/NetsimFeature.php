...
// BerufsbildungDatenExporte SDK netsim feature
...
class BerufsbildungDatenExporteNetsimFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _simulate(BerufsbildungDatenExporteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BerufsbildungDatenExporteContext $ctx, array $applied): void
    {
        $client = $this->client;
