...
// BerufsbildungDatenExporte SDK telemetry feature
...
class BerufsbildungDatenExporteTelemetryFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _close(BerufsbildungDatenExporteContext $ctx, bool $ok): void
    {
