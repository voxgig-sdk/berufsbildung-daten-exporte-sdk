...
// BerufsbildungDatenExporte SDK cache feature
...
class BerufsbildungDatenExporteCacheFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _through(BerufsbildungDatenExporteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
