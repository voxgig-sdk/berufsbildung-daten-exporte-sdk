...
class BerufsbildungDatenExporteSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = BerufsbildungDatenExporteHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = BerufsbildungDatenExporteHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!BerufsbildungDatenExporteFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, BerufsbildungDatenExporteFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return BerufsbildungDatenExporteUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = BerufsbildungDatenExporteHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = BerufsbildungDatenExporteHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = BerufsbildungDatenExporteHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new BerufsbildungDatenExporteError($op . "_allow",
                "BerufsbildungDatenExporteSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = BerufsbildungDatenExporteHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new BerufsbildungDatenExporteError("graphql_error",
                "BerufsbildungDatenExporteSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Berufsbildung($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_berufsbildung === null) {
                $this->_berufsbildung = new BerufsbildungEntity($this, null);
            }
            return $this->_berufsbildung;
        }
        return new BerufsbildungEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new BerufsbildungDatenExporteSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
