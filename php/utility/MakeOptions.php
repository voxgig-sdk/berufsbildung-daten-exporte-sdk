...
// BerufsbildungDatenExporte SDK utility: make_options

class BerufsbildungDatenExporteMakeOptions
{
    ...
    public static function call(BerufsbildungDatenExporteContext $ctx): array
    {
        ...
        //
        // `BerufsbildungDatenExporteSchema::optspec()` is built from the model:
        ...
        $optspec = BerufsbildungDatenExporteSchema::optspec();
