...
// BerufsbildungDatenExporte SDK utility: fetcher

class BerufsbildungDatenExporteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BerufsbildungDatenExporteSDK/1.0)';
    ...
    public static function call(BerufsbildungDatenExporteContext $ctx, string $fullurl, array $fetchdef): array
    {
