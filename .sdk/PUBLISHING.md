...
|---|---|---|
| `ts/` | @voxgig-sdk/berufsbildung-daten-exporte-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/berufsbildung-daten-exporte-sdk \
      --repository voxgig-sdk/berufsbildung-daten-exporte-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/berufsbildung-daten-exporte-sdk` shows it, and
`npm trust revoke @voxgig-sdk/berufsbildung-daten-exporte-sdk --id=<id>` removes it.
