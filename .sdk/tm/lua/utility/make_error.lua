...
local function make_error_util(ctx, err)
  ...
  local msg = "BerufsbildungDatenExporteSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BerufsbildungDatenExporteError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BerufsbildungDatenExporteError then
