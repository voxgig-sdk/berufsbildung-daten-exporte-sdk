...
// BerufsbildungDatenExporte SDK utility type

class BerufsbildungDatenExporteUtility
{
    ...
    public static function copy(BerufsbildungDatenExporteUtility $src): BerufsbildungDatenExporteUtility
    {
        $u = new BerufsbildungDatenExporteUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
