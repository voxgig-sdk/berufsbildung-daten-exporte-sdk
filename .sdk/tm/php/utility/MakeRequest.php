...
// BerufsbildungDatenExporte SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BerufsbildungDatenExporteMakeRequest
{
    public static function call(BerufsbildungDatenExporteContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BerufsbildungDatenExporteResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BerufsbildungDatenExporteResponse($fetched);
        } else {
