...
// BerufsbildungDatenExporte SDK utility: result_basic

class BerufsbildungDatenExporteResultBasic
{
    public static function call(BerufsbildungDatenExporteContext $ctx): ?BerufsbildungDatenExporteResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BerufsbildungDatenExporteError) ? $result->err->msg : (string)$result->err;
