...
// BerufsbildungDatenExporte SDK utility: graphql
//
...
class BerufsbildungDatenExporteGraphql
{
    ...
    // equivalent.
    public static function body(BerufsbildungDatenExporteContext $ctx): mixed
    {
    ...
    public static function errors(BerufsbildungDatenExporteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
