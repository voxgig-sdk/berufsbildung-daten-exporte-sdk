...
// BerufsbildungDatenExporte SDK rbac feature
...
class BerufsbildungDatenExporteRbacFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _required(BerufsbildungDatenExporteContext $ctx): ?string
    {
    ...
    private function _reject(BerufsbildungDatenExporteContext $ctx, string $required): void
    {
    ...
    private function _track(BerufsbildungDatenExporteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
