...
// BerufsbildungDatenExporte SDK audit feature
...
class BerufsbildungDatenExporteAuditFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _emit(BerufsbildungDatenExporteContext $ctx, string $outcome): void
    {
