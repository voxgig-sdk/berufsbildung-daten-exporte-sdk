...
// BerufsbildungDatenExporte SDK proxy feature
...
class BerufsbildungDatenExporteProxyFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    public function init(BerufsbildungDatenExporteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BerufsbildungDatenExporteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
