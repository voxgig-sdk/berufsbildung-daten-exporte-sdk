...
// BerufsbildungDatenExporte SDK ratelimit feature
...
class BerufsbildungDatenExporteRatelimitFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _acquire(BerufsbildungDatenExporteContext $ctx): void
    {
    ...
    private function _track(BerufsbildungDatenExporteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
