...
// BerufsbildungDatenExporte SDK timeout feature
...
class BerufsbildungDatenExporteTimeoutFeature extends BerufsbildungDatenExporteBaseFeature
{
    ...
    private function _with_timeout(BerufsbildungDatenExporteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BerufsbildungDatenExporteContext $_ctx, float $ms): void
    {
        $client = $this->client;
