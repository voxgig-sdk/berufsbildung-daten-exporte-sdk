...
// instead of `sdk.NewBerufsbildungDatenExporteSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *BerufsbildungDatenExporteSDK  { return NewBerufsbildungDatenExporteSDK(nil) }
func Test() *BerufsbildungDatenExporteSDK { return TestSDK(nil, nil) }
